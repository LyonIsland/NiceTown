...
public class ButtonHandle : MonoBehaviour
{
    ...
    private void InitializeSize()
    {
        ...
        {
            //rectTransform.sizeDelta = new Vector2(60, 60);  // ���ô�СΪ60px x 60px
            //rectTransform.position = transform.parent.parent.position;  // ����λ��Ϊparent��parent������λ��
    ...
    private void ToggleDialogueFrame()
    {
        ...
        {
            Initialization();  // ���DialogueFrame�����ִ�г�ʼ��
        }
        else
        {
            RemoveListeners();  // ���DialogueFrame�����ã��Ƴ����м�����
        }
    }
