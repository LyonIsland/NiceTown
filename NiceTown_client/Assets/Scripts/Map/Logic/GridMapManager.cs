...
namespace MFarm.Map
{
    public class GridMapManager : Singleton<GridMapManager>, ISaveable
    {
        ...
        public bool GetGridDimensions(string sceneName, out Vector2Int gridDimensions, out Vector2Int gridOrigin)
        {
            ...
            foreach (var mapData in mapDataList)
            {
                if (mapData.sceneName == sceneName)
                {
                    ...
                    gridOrigin = new Vector2Int(mapData.originX, mapData.originY);
                    return true;
                }
            }
            return false;
        ...
        // public bool GetGridDimension(string sceneName, out Vector2Int gridDimensions, out Vector2Int gridOrigin)
        // {
        //     gridDimensions = Vector2Int.zero;
        //     gridOrigin = Vector2Int.zero;
        //     foreach (var mapDate in mapDataList)
        //     {
        //         if (mapDate.sceneName == sceneName)
        //         {
        //             gridDimensions = new Vector2Int(mapDate.width, mapDate.hight);
        //             gridOrigin = new Vector2Int(mapDate.xIndex, mapDate.yIndex);
        //             return true;
        //         }
        //     }
        //
